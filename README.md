...
| `subnet-id`                                                                                                                                                                  | Required if you use the `start` mode and do not specify the `vpc-id`. This cannot be used with `vpc-id`.     | VPC Subnet Id. <br><br> The subnet should belong to the same VPC as the specified security group.                                                                                                                                                                                                                                     |
